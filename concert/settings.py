...
with open(os.path.join(
        BASE_DIR, 'concert', 'secrets.json')) as f:
...
SECRET_KEY = 'django-insecure-e(o+960#p5b#27(-f$181g3m7#ov5xtpqjxd)4i%l_8mh&&%j+'
...
STATIC_URL = 'static/'
STATIC_ROOT = os.path.join(os.path.dirname(BASE_DIR), "concerts_django_static")
